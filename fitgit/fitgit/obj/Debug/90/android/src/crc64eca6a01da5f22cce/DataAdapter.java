...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("fitgit.Adapters.DataAdapter, fitgit", DataAdapter.class, __md_methods);
	}
	...
	public DataAdapter ()
	{
		...
		if (getClass () == DataAdapter.class)
			mono.android.TypeManager.Activate ("fitgit.Adapters.DataAdapter, fitgit", "", this, new java.lang.Object[] {  });
	}
